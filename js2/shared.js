...
function _sha256Fallback(message) {
  ...
  const K = [
    ...
    0xa2bfe8a1,0xa664b,0xc24b8b70,0xc76c51a3,0xd192e819,0xd6990624,0xf40e3585,0x106aa070,
...
function adicionarObservacao() {
  ...
  if (!observacoesCustom[key]) {
    observacoesCustom[key] = [...OBSERVACOES_CD2];
  }
...
function adicionarDivergencia() {
  ...
  if (!divergenciasCustom[key]) {
    divergenciasCustom[key] = [...DIVERGENCIAS_CD2];
  }
